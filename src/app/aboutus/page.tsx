...
export default async function Aboutus() {
  ...
  return (
    ...
    //     <h1 className="error font-bold text-3xl">About us</h1>
    // </div>
    <section className="text-gray-600 body-font">
  <div className="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
    <Image width={200} height={200} className="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src="/images/a.jpg"/>
